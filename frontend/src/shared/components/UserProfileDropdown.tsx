...
export function UserProfileDropdown({
  ...
  const handleProfileClick = () => {
    // Always navigate to own profile by updating URL
    window.location.href = "/dashboard?page=profile";
  };
  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuSeparator
          className={darkTheme ? "bg-white/10" : "bg-white/20"}
        />
